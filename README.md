...
├── planeacion\\\_anual.html   ← tabla mensual 2026 + progreso de objetivos anuales
├── malla\\\_psic.html         ← malla curricular psicología UAS + calculadora promedio
├── malla\\\_software.html     ← malla desarrollo de software (pendiente)
...
### `planeacion\\\_anual.html` — tabla 2026
...
### `malla\\\_psic.html` — psicología UAS
...
2. Toca **⚙ config**
3. Ingresa tu token de GitHub (`ghp\\\_...`)
4. El repositorio ya está configurado como `vd159817/mi\\\_tracker`
